        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Foto = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    MoradorId = table.Column<string>(type: "nvarchar(450)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    PagamentoId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    UsuarioId = table.Column<string>(type: "nvarchar(450)", nullable: true),
                    AlugueiId = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "d84142db-13b0-4aa6-8323-cc510132d874", "17c51c6a-e239-4bf0-8c0c-4b5e69705db6", "Morador do Prédio", "Morador", "MORADOR" },
                    { "527ab037-06ad-4df2-9d63-10d85b7e43da", "7a384a67-dffa-4564-81ca-a65874e28bc5", "Sindico do Prédio", "Sindico", "SINDICO" },
                    { "389aa847-fd83-4a03-8cb5-9f0d31da898e", "43f0cb3e-e614-4373-8c37-11a4c72c8529", "Administrador do Prédio", "Administrador", "ADMINISTRADOR" }
                });
